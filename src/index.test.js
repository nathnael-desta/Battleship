...
import { insertAt, getTile, finalTile, occupies, removeDiv, checkIfFlipIsOk , insertInsideArray, checkIfInsertable, addableSquares, checkSurrounding} from "./board.js";
...
describe("insertion tests", () => {
  ...
  test("clicking ai", () => {
    tilesOverlay = ["00", "01", "02", "03", "04", "05", "06", "07", "08",
